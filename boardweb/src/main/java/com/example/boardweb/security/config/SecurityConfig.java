...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        .requestMatchers(
            "/login","/" ,"/register","/css/**","/js/**","/images/**","/security/join",
        "/security/register","/security/verify","/security/request-verification","/security/verify-info", 
        "/security/check-verified","/boardweb/**","/login/oauth2/**"
        ).permitAll()
        ...
        .defaultSuccessUrl("/boardweb/list", true) // 로그인 성공 시 이동할 페이지
